              ...
              <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end border-t border-gray-50 pt-6 mt-2 gap-6">
                ...
                {!sol.cancelada && (
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {sol.paqueteGenerado ? (
                      <button className="px-3 py-1.5 text-[10px] font-bold border-2 border-green-600 text-green-600 rounded-lg uppercase transition-all hover:bg-green-600 hover:text-white active:scale-95 whitespace-nowrap">
                        Generar paquete
                      </button>
                    ) : (
                      <button className="px-3 py-1.5 text-[10px] font-bold border-2 border-gray-400 text-gray-500 rounded-lg uppercase transition-all hover:bg-gray-400 hover:text-white active:scale-95 whitespace-nowrap">
                        Generar paquete
                      </button>
                    )}
                  </div>
